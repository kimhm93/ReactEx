...
/*
    ...
    변수 => const : 상수형 변수
            ...
            화살표 함수 => function,return을 생략하고 싶을 경우
            function aaa(){}
            
            const aaa=()=>{}
            const aaa=function(){}

            for => forEach,map 둘다 똑같은 기능
            ...
            React => 상태 관리 프로그램
                     === state =========> 데이터 관리 프로그램
            <App4 movie={movie} aaa={} bbb={}/>
                  ============= 생성자의 매개변수에 값을 전송

            class App4 extends Component{
                constructor(props) => this.props.movie props.aaa props.bbb
                {
                    props, state => 멤버변수 (class영역 전체에서 사요 할 수 있는 변수)
                    props => 변경할 수 없는 변수
                    state => 변경해서 사용하는 변수
